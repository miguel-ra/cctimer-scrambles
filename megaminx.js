...
const scramble = (function() {
  ...
  var colors = [
    defaultColors.white,
    defaultColors.darkGreen,
    defaultColors.red,
    defaultColors.darkBlue,
    defaultColors.darkYellow,
    defaultColors.darkPurple,
  ...
  function drawPolygon(r, fillColor, arrx, arry) {
    ...
    return r.path(pathString).attr({fill: fillColor, stroke: defaultColors.black});
  }
