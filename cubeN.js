...
function generateCubeNScramble(size, seqlen, mult) {
  // Default settings
  //var size=3;
  //var seqlen=30;
  var numcub = 1;
...
export default {
  cube4: generateCubeNScramble(4, 40, true),
  cube5: generateCubeNScramble(5, 60, true),
  cube6: generateCubeNScramble(6, 70, true),
  cube7: generateCubeNScramble(7, 100, true),
  cube8: generateCubeNScramble(8, 120, true),
  cube9: generateCubeNScramble(9, 120, true),
  cube10: generateCubeNScramble(10, 120, true),
  cube11: generateCubeNScramble(11, 120, true),
};
