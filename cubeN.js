...
const scramble = (function () {
  var generateScramble = function (size, seqlen, mult) {
    return (function () {
      // Default settings
      //var size=3;
      //var seqlen=30;
      ...
      function scramble() {
        ...
        for (var n = 0; n < numcub; n++) {
          ...
          while (seq[n].length + moved < seqlen) {
            ...
            do {
              do {
                ...
                ax = randomInt.below(3);
                // choose a random move type on that axis
                sl = randomInt.below(tl);
          ...
          seq[n][seq[n].length] = cubeorient ? randomInt.below(24) : 0;
        }
      }
      ...
      return {
        ...
        setRandomSource: function () {
          console.log(
            "setRandomSource is deprecated. It has no effect anymore."
          );
        },
  ...
  /* mark2 interface */
  return {
    cube4: generateScramble(4, 40, true),
    cube5: generateScramble(5, 60, true),
    cube6: generateScramble(6, 70, true),
    cube7: generateScramble(7, 100, true),
    cube8: generateScramble(8, 120, true),
    cube9: generateScramble(9, 120, true),
    cube10: generateScramble(10, 120, true),
    cube11: generateScramble(11, 120, true),
  };
})();
